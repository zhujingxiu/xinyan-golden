                ...
                <div class="box-body">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            ...
                            <li style="display: none;"><a href="#recycling" data-toggle="tab">金生金</a></li>

                            <li style="display: none;"><a href="#tab_3" data-toggle="tab">其他</a></li>
                                ...
                                <div class="row">
                                    <div class="col-sm-5">
                                        ...
                                        <div class="form-group clearfix">
                                            <label for="inputSite" class="control-label col-sm-4 text-right">站点名称
                                        ...
                                        <div class="form-group clearfix">
                                            <label for="inputTitle" class="control-label col-sm-4 text-right">站点标题
                                        ...
                                        <div class="form-group clearfix">
                                            <label for="inputKeywords" class="control-label col-sm-4 text-right">SEO Keywords
                                        ...
                                        <div class="form-group clearfix">
                                            <label for="inputDescription" class="control-label col-sm-4 text-right">SEO Description
