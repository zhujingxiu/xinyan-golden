...
*/
$config['tables']['users']           = 'worker';
$config['tables']['groups']          = 'worker_group';
$config['tables']['users_groups']    = 'worker_rel';
$config['tables']['login_attempts']  = 'worker_attempt';
